...
rewardsApi.prototype.getRewards = async function (user, pass, isMobile) {
...
function generateRandomSearch(number) {
    return Array.from(new Array(number), (x, i) => {
        switch(i % 3) {
            case 0:
                return chance.currency().name;
                break;
            case 1:
                return casual.catch_phrase;
                break;
            case 2:
